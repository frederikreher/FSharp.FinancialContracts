...
module Contract =
    ...
    type Contract = 
        ...
        | Delay    of Time * Contract                      // Acquire the contract at the provided time.
        ...
        | If       of BoolObs * Time * Contract * Contract // Acquire the first contract at the point where the observable 
