...
module Contract =
    ...
    type Contract = 
        ...
        | If       of BoolObs * Contract * Contract // Acquire the first contract at the point where the observable 
    ...
    let rec horizon c (t:Time) : Time = 0
    ...
    let rec observables c boolAcc numAcc : BoolObs list * NumberObs list =
        ...
        | If(obs, c1, c2)              ->       let (boolAcc1,numAcc1) = boolObs obs boolAcc numAcc
